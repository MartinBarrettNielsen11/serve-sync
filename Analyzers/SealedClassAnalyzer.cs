...
public sealed class SealedClassAnalyzer : DiagnosticAnalyzer
{
    ...
    private static void AnalyzeSealedClass(SyntaxNodeAnalysisContext context)
    {
        ...
        Diagnostic diagnostic = Diagnostic.Create(Rule, classSyntax.Keyword.GetLocation());
        context.ReportDiagnostic(diagnostic);
    }

    internal override ImmutableArray<DiagnosticDescriptor> SupportedDiagnostics => [Rule];
}
