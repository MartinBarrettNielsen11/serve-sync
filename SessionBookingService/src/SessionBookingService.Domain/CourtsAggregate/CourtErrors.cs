...
{
    internal static readonly Error NumberOfSessionsCannotExceedSubscriptionLimit = Error.Failure(
    ...
    internal static readonly Error SessionsCannotOverlap = Error.Failure(
