...
namespace SessionBookingService.UnitTests.Domain.PlayerAggregate;
...
public class PlayerTests
{
        ...
        int endHourSession2)
    {
        ...
        Session session1 = SessionFactory.CreateSession(
            ...
            timeRange: TimeSlotFactory.Create(startHour: startHourSession1, endHour: endHourSession1),
            id: Guid.NewGuid());

        Session session2 = SessionFactory.CreateSession(
            date: SessionConstants.Date,
            timeRange: TimeSlotFactory.Create(startHour: startHourSession2, endHour: endHourSession2),
