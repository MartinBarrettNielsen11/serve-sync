...
internal static class TimeSlotFactory
{
	...
	{
		if (startHour is < 0 or > 23 || startHour >= endHour) throw new ArgumentOutOfRangeException(nameof(startHour));

		if (endHour is < 1 or > 24) throw new ArgumentOutOfRangeException(nameof(endHour));
